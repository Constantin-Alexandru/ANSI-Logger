...
function info(message) {
  ...
  process.stdout.write(`${Date.now().toLocaleString()} [INFO]: `);
...
function success(message) {
  ...
  ansi_lib.SET_EFFECT(ansi_lib.TEXT_EFFECTS.BOLD);
  process.stdout.write(`${Date.now().toLocaleString()} [SUCCESS]: `);
  ansi_lib.SET_EFFECT(ansi_lib.TEXT_EFFECTS.BOLD_RESET);
...
function warn(message) {
  ...
  ansi_lib.SET_EFFECT(ansi_lib.TEXT_EFFECTS.BOLD);
  process.stdout.write(`${Date.now().toLocaleString()} [WARN]: `);
  ansi_lib.SET_EFFECT(ansi_lib.TEXT_EFFECTS.BOLD_RESET);
  process.stdout.write(message);
  ansi_lib.SET_FOUR_BIT_COLOR(ansi_lib.COLOR_4_BIT.TXT_DEFAULT);
  console.log();
...
function error(message) {
  ...
  ansi_lib.SET_EFFECT(ansi_lib.TEXT_EFFECTS.BOLD);
  process.stdout.write(`${Date.now().toLocaleString()} [RED]: `);
  ansi_lib.SET_EFFECT(ansi_lib.TEXT_EFFECTS.BOLD_RESET);
  process.stdout.write(message);
  ansi_lib.SET_FOUR_BIT_COLOR(ansi_lib.COLOR_4_BIT.TXT_DEFAULT);
  console.log();
